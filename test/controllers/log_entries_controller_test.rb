...
class LogEntriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create log_entry" do
    assert_difference('LogEntry.count') do
      post log_entries_url, params: { log_entry: { date: @log_entry.date, habit_id: @log_entry.habit_id, note: @log_entry.note } }
    end
  ...
  test "should update log_entry" do
    patch log_entry_url(@log_entry), params: { log_entry: { date: @log_entry.date, habit_id: @log_entry.habit_id, note: @log_entry.note } }
